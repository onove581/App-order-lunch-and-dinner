        ...
        else
        {
            ...
            if(mLastLocation != null)
            {
                ...
                try {
                    ...
                    //draw polyline
                    GoogleDirection.withServerKey("AIzaSyCZswgEZCMua-ukLIyIjPdvoBy7RJ2ZaNk")
                            .from(yourLocation)
                            .to(userLocation)
                            ...
                            .execute(new DirectionCallback() {
                                ...
                                public void onDirectionSuccess(Direction direction, String rawBody) {
                                    if (direction.isOK()) {
                                        ...
                                        // Do something
                                        Toast.makeText(com.example.landdserver.TrackingOrderActivity.this, rawBody, Toast.LENGTH_SHORT).show();
                                        Log.e("key", rawBody);
                                    }
                                }
                                ...
                                public void onDirectionFailure(Throwable t) {
                                    Toast.makeText(com.example.landdserver.TrackingOrderActivity.this, "Cannot draw polyline", Toast.LENGTH_SHORT).show();
                                }
                            });
                }
                catch (Exception e)
