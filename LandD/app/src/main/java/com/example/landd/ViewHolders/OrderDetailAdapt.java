...
List<Order> myorder;
    ...
    @NonNull
    @Override
    public com.example.landd.ViewHolders.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View item= LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_order__detail__layout,parent,false);

        return new com.example.landd.ViewHolders.MyViewHolder(item);
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.landd.ViewHolders.MyViewHolder holder, int position) {
